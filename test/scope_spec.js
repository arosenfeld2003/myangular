...
describe('Scope', function() {
  ...
  describe('$applyAsync', function() {
    ...
    it('coalesces many calls to $applyAsync', function(done) {
      ...
      scope.$applyAsync(function(scope) {
        // async function pushed to scope.applyAsyncQueue.
        scope.aValue = 'abc';
      });
      scope.$applyAsync(function(scope) {
        scope.aValue = 'def';
  ...
  describe('$watchCollection', function() {
    ...
    it('notices when a value becomes an object', function() {
        scope.counter = 0;
        scope.$watchCollection(
    ...
    it('gives the old array values to listeners', function() {
      scope.aValue = [1, 2, 3];
      var oldValueGiven;
      scope.$watchCollection(
        function(scope) { return scope.aValue; },
  ...
  describe('Events', function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      it('calls listeners registered for matching events on' + method, function() {
        ...
        it('sets defaultPrevents when preventDefault is called on '+method, function() {
    ...
    it('propogates down the scope heirarchy on $broadcast', function() {
      var scopeListener = jasmine.createSpy();
